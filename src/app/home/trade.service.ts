...
export class TradeService {
  ...
  private tradesSubject: BehaviorSubject<Item[]> = new BehaviorSubject<Item[]>(
    []
  );
  ...
  loadTrades(page: number, pageSize: number = 10): Observable<Trade[]> {
    const url = `${environment.API_URL}/api/Trade`;
