...
export class ItemFacade {
    ...
    constructor(private itemExtrasService: ItemExtrasService, private itemService: ItemSelectorService, private router: Router) { }
    ...
    onItemSelect(mode: string) {
        if (!['inventory', 'allItem'].includes(mode) &&
